# Elfy — Attributes: LEGACY archive

> **Archived historical reference.** These sections were split out of
> `../attributes.md` on 2026-07-09 to keep the live doc focused on the
> **Current State**. Everything here describes *superseded* behaviour
> (pre-Session-2 combat math, Round-39 win-rate sweeps, the original EP
> design plan). It is kept for trail/context only — **code wins on
> conflicts**, and the live rules live in `../attributes.md` →
> "Current State". Do not tune against the numbers below.
